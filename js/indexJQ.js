$(document).ready(function () {
  ...
  // Bootstrap 5 compatible event listeners
  const collapseElement = document.getElementById("nav_traka");
  if (collapseElement) {
    collapseElement.addEventListener("show.bs.collapse", function () {
      ...
      $(".navbar-nav > li:nth-child(n + 2):nth-child(-n + 5) > svg").css(
        "left",
        "42%"
      );
  ...
  $(window).resize(function () {
    if ($(window).width() > 768) {
      ...
      // Bootstrap 5 compatible collapse hide
      const collapseEl = document.getElementById("nav_traka");
  ...
  $("#skolica").hover(
    function () {
      $(this).addClass("sijanje");
    },
    function () {
      $(this).removeClass("sijanje");
    }
  );
  $("#crveno").hover(
    function () {
